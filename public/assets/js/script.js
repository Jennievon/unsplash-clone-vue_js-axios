...
;(function($) {
  ...
  $doc.on('click', 'body', function(e) {
    if (!$toggle_nav.is(e.target) && $toggle_nav.has(e.target).length === 0 && !$navbar.is(e.target) && $navbar.has(e.target).length === 0) {
  ...
  $doc.on('click', 'body', function(e) {
    if (!$chat_trigger.is(e.target) && $chat_trigger.has(e.target).length === 0 && !$chat_contacts.is(e.target) && $chat_contacts.has(e.target).length === 0) {
      $chat_contacts.removeClass('active')
      $chat_wrap.removeClass('contact-active')
    }
    if (!$show_info.is(e.target) && $show_info.has(e.target).length === 0 && !$chat_info.is(e.target) && $chat_info.has(e.target).length === 0 && $win.width() < 992) {
    ...
    if (!$show_search.is(e.target) && $show_search.has(e.target).length === 0 && !$chat_search.is(e.target) && $chat_search.has(e.target).length === 0) {
